				...
				<div class="XXLflex XXLh-100">
					<div class="XXLw-80 Sw-90 XXLmAuto">
						<div id="userForm" class="XXLw-100 XXLh-100 XXLbr20">
							<form action={{ route('password.update') }} method="POST" class="grid XXLh-100">
								@csrf
								@method('PATCH')
								...
								<ul class="XXLspan-6 Mspan-12 lsNone XXLflexVerticalAlign">
									<div>
										<li class="XXLflexVerticalAlign P1 mb1">
											<label for="current_password" class="XXLw-80 XXLmAuto fcIce uc XXLfw600">
												Mot de passe actuelle
											</label>
											<div class="XXLw-80 XXLmAuto inputArea XXLbr10 bgLightGrey XXLflexHorizontalAlign pr1">
												<input class="XXLw-100 bgLightGrey" type="password" id="current_password" name="current_password" />
												<img src="{{ asset('img/afficher-mot-de-passe.png') }}" alt="Afficher le mot de passe" id="eye1"
													onclick="change1()" />
											</div>
										</li>
										<li class="XXLflexVerticalAlign P1 mb1">
