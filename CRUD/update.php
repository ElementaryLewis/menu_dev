...
if (!empty($_POST)) {
    ...
    if (!$errors) {
        ...
        $query1 = $pdo->prepare(
            'UPDATE menu 
        SET date = :date, midi_soir = :midi_soir
        ...
        // Update Aliments Database
        $query2 = $pdo->prepare(
            'UPDATE aliments 
        SET date = :date, midi_soir = :midi_soir,
        entree1 = :entree1, entree2 = :entree2, entree3 = :entree3, entree4 = :entree4, 
        plat1 = :plat1, plat2 = :plat2, plat3 = :plat3, plat4 = :plat4, 
        accomp1 = :accomp1, accomp2 = :accomp2, accomp3 = :accomp3, 
        fromage1 = :fromage1, fromage2 = :fromage2, fromage3 = :fromage3, fromage4 = :fromage4, 
        dessert1 = :dessert1, dessert2 = :dessert2, dessert3 = :dessert3, dessert4 = :dessert4, 
        ...
        // Update Bio Category Database
        $query3 = $pdo->prepare(
            'UPDATE cat_bio 
        SET date = :date, midi_soir = :midi_soir,
        ab_entree1 = :ab_entree1, ab_entree2 = :ab_entree2, ab_entree3 = :ab_entree3, ab_entree4 = :ab_entree4, 
        ab_plat1 = :ab_plat1, ab_plat2 = :ab_plat2, ab_plat3 = :ab_plat3, ab_plat4 = :ab_plat4, 
        ab_accomp1 = :ab_accomp1, ab_accomp2 = :ab_accomp2, ab_accomp3 = :ab_accomp3, 
        ab_fromage1 = :ab_fromage1, ab_fromage2 = :ab_fromage2, ab_fromage3 = :ab_fromage3, ab_fromage4 = :ab_fromage4, 
        ab_dessert1 = :ab_dessert1, ab_dessert2 = :ab_dessert2, ab_dessert3 = :ab_dessert3, ab_dessert4 = :ab_dessert4, 
        ab_fruit1 = :ab_fruit1, ab_fruit2 = :ab_fruit2
        WHERE date = :date AND midi_soir = :midi_soir'
        );
        ...
        // Update Toque Category Database
        $query4 = $pdo->prepare(
            'UPDATE cat_maison  
        SET date = :date, midi_soir = :midi_soir,
        toque_entree1 = :toque_entree1, toque_entree2 = :toque_entree2, toque_entree3 = :toque_entree3, toque_entree4 = :toque_entree4, 
        toque_plat1 = :toque_plat1, toque_plat2 = :toque_plat2, toque_plat3 = :toque_plat3, toque_plat4 = :toque_plat4, 
        toque_accomp1 = :toque_accomp1, toque_accomp2 = :toque_accomp2, toque_accomp3 = :toque_accomp3, 
        toque_dessert1 = :toque_dessert1, toque_dessert2 = :toque_dessert2, toque_dessert3 = :toque_dessert3, toque_dessert4 = :toque_dessert4
        WHERE date = :date AND midi_soir = :midi_soir'
        );
        ...
        // Update Europe Category Database
        $query5 = $pdo->prepare(
            'UPDATE cat_europe 
        SET date = :date, midi_soir = :midi_soir,
        eu_fromage1 = :eu_fromage1, eu_fromage2 = :eu_fromage2, eu_fromage3 = :eu_fromage3, eu_fromage4 = :eu_fromage4, 
        eu_dessert1 = :eu_dessert1, eu_dessert2 = :eu_dessert2, eu_dessert3 = :eu_dessert3, eu_dessert4 = :eu_dessert4, 
        eu_fruit1 = :eu_fruit1, eu_fruit2 = :eu_fruit2
        WHERE date = :date AND midi_soir = :midi_soir'
        );
...
header('Location: ../index.php?menu=updated');
